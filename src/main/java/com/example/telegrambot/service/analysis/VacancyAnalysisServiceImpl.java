...
public class VacancyAnalysisServiceImpl implements VacancyAnalysisService {
    ...
    public String analyze(User user, String vacancyText) {
        ...
        **Task:** Based on the candidate's RESUME and the JOB VACANCY, create a complete "Application Pack".
        ...
        **Instructions:**
        ...
        - Include 3-4 technical questions related to the required technologies (e.g., "Can you explain the difference between...").
